...
if(navToggle){
    navToggle.addEventListener('click' , () =>{
        navMenu.classList.add('show-mwnu')
    })
}
...
modalClick.forEach((modalClose) => {
    modalClose.addEventListener('click', () =>{
        modalViews.forEach((modalViews) =>{
            modalViews.classList.remove('actiive-modal')
        })
    })
})
...
themeButton.addEventListener('click', () => {
    ...
    // We save the theme and the currnet icon that the user chose
